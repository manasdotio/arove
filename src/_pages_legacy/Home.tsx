...
import { PROJECTS, TESTIMONIALS, ARTICLES, PROCESS_STEPS, FAQ_ITEMS } from '../data/constants';
...
export const Home: React.FC = () => {
  ...
  // Section observers for entrance scroll animations
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
          ...
          <h1 className="text-4xl min-[400px]:text-5xl sm:text-6xl lg:text-8xl xl:text-[105px] font-bold tracking-tighter leading-[0.9] mb-6 md:mb-12 font-display uppercase stagger-item transition-all duration-700 text-text-main" style={{ transitionDelay: '200ms' }}>
            ...
            <span className="inline-block">websites</span> <br className="hidden md:inline" />
      ...
      <section 
        ref={projectsRef}
        id="projects" 
        className={`py-12 sm:py-20 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 reveal ${projectsVisible ? 'active' : ''}`}
      >
      ...
      <section 
        ref={aboutRef}
        id="about" 
        className={`py-12 sm:py-20 md:py-32 max-w-7xl mx-auto px-4 sm:px-6 reveal ${aboutVisible ? 'active' : ''}`}
      >
      ...
      <section 
        ref={servicesRef}
        id="services" 
        className={`py-12 sm:py-20 md:py-32 bg-surface-container-low/40 reveal ${servicesVisible ? 'active' : ''}`}
      >
      ...
      <section 
        id="planner"
        className="py-12 sm:py-20 md:py-32 max-w-7xl mx-auto px-4 sm:px-6"
      >
      ...
      <section 
        ref={journalRef}
        id="journal" 
        className={`py-12 sm:py-20 md:py-32 bg-surface border-b border-fine reveal ${journalVisible ? 'active' : ''}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10 md:mb-24">
      ...
      <section 
        ref={contactRef}
        id="contact" 
        className={`py-12 sm:py-20 md:py-32 bg-surface reveal ${contactVisible ? 'active' : ''}`}
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-20">
            ...
            <div className="lg:col-span-7 bg-surface-container-low/40 p-5 sm:p-10 rounded-[2rem] border border-fine">
              {inlineSubmitSuccess ? (
                ...
                <form onSubmit={handleInlineFormSubmit} className="space-y-4 md:space-y-6">
                  <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                    <div>
                      <label htmlFor="home-contact-name" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                        Your Name
                      </label>
                      <input
                    ...
                    <div>
                      <label htmlFor="home-contact-email" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                        Email Address
                      </label>
                      <input
                  ...
                  <div>
                    <label htmlFor="home-contact-subject" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                      Subject
                    </label>
                    <input
                      ...
                      onChange={handleInlineInputChange}
                      placeholder="e.g. Rebranding & Custom Build"
                      className="w-full bg-surface-container-lowest border border-fine rounded-xl px-4 py-3.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/40 focus:border-primary/40 placeholder:text-on-surface/30 shadow-sm"
                    />
                  </div>

                  <div>
                    <label htmlFor="home-contact-message" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                      Project Brief & Details
                    </label>
                    <textarea
