            ...
            {submitSuccess ? (
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4 md:space-y-6">
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div>
                    <label htmlFor="contact-name-input" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                      Your Name
                    </label>
                    <input
                  ...
                  <div>
                    <label htmlFor="contact-email-input" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                      Email Address
                    </label>
                    <input
                ...
                <div>
                  <label htmlFor="contact-subject-input" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                    Subject
                  </label>
                  <input
                ...
                <div>
                  <label htmlFor="contact-message-input" className="block text-xs font-bold uppercase tracking-widest text-on-surface/50 mb-1.5">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    placeholder="Tell us a little bit about your goals, timeline, or current website..."
